# ![Juice Shop Logo](https://raw.githubusercontent.com/bkimminich/juice-shop/master/frontend/src/assets/public/images/JuiceShop_Logo_100px.png) Green Juice (OWASP Juice Shop)
...
This is just a simple skin customizations of the OWASP Juice Shop for demo purposes.  There is no customizations of the vulnerablities in
the application just some of the text on pages and user data has been changed to support the demo purposes.
Everythink else about the shop is the same.
